...
function buildDocsSection(params: { docsPath?: string; isMinimal: boolean; readToolName: string }) {
  ...
  return [
    "## Documentation",
    `Platform docs: ${docsPath}`,
    "Mirror: https://docs.openclaw.ai",
    "Source: https://github.com/openclaw/openclaw",
    "Community: https://discord.com/invite/clawd",
    "Find new skills: https://clawhub.com",
    "For platform behavior, commands, config, or architecture: consult local docs first.",
    "When diagnosing issues, run `selah status` yourself when possible; only ask the user if you lack access (e.g., sandboxed).",
    "",
  ];
}
...
export function buildAgentSystemPrompt(params: {
  ...
  const coreToolSummaries: Record<string, string> = {
    ...
    gateway: "Restart, apply config, or run updates on the running platform process",
  ...
  if (promptMode === "none") {
    return "You are Selah, a managed AI assistant.";
  }

  const lines = [
    "You are Selah, a managed AI assistant.",
    "",
    "## Tooling",
    ...
    ...safetySection,
    "## CLI Quick Reference",
    "The platform is controlled via subcommands. Do not invent commands.",
    "To manage the Gateway daemon service (start/stop/restart):",
    "- selah gateway status",
    "- selah gateway start",
    "- selah gateway stop",
    "- selah gateway restart",
    "If unsure, ask the user to run `selah help` (or `selah gateway --help`) and paste the output.",
    "",
    ...skillsSection,
    ...memorySection,
    ...
    hasGateway && !isMinimal
      ? [
          ...
          "After restart, The platform pings the last active session automatically.",
        ].join("\n")
      : "",
    hasGateway && !isMinimal ? "" : "",
    "",
    ...
    "These user-editable files are loaded by the platform and included below in Project Context.",
    "",
  ...
  if (!isMinimal) {
    lines.push(
      ...
      "HEARTBEAT_OK",
      'The platform treats a leading/trailing "HEARTBEAT_OK" as a heartbeat ack (and may discard it).',
